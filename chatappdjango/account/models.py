...
def get_defualt_profile_image():
    return "chatapp/logo_1080_1080.png"
...
class Account(AbstractBaseUser):
    ...
    profile_image = models.ImageField(max_length=255,upload_to=get_profile_image_file_path,null=True,blank=True,default=get_defualt_profile_image,)
